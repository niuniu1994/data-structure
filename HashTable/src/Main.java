...
public class Main {
    ...
    public void test1(HashTable<String,Integer> map1, String file){
        ArrayList<String> words = new ArrayList<>();
        FileOperation.readFile(file,words);
        System.out.println("Words Size : " + words.size());
    ...
    public static void main(String[] args) {
        ...
        HashTable<String,Integer> map3 = new HashTable<>(13102);
        ...
        System.out.println();
        m.test1(map3,"/Users/kainingxin/Desktop/life.txt");
